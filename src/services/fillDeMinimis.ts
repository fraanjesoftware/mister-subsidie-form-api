...
interface DeMinimisFormData {
  generalData?: GeneralData;
  selectedOption: number;
  option2Data?: OptionData;
  option3Data?: OptionData;
...
async function fillDeMinimisForm(
  data: DeMinimisFormData,
  ...
  try {
    ...
    throw new Error(`Error filling De-minimis PDF: ${(error as Error).message}`);
  }
}

export { fillDeMinimisForm };